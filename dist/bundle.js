...
class Colors {
    ...
    static getRandomColorHex(allowRepetition) {
        if (allowRepetition) {
            ...
            let randomIndex = Math.floor(Math.random() * this.colorsHex.length);
...
document.addEventListener('DOMContentLoaded', () => {
    __WEBPACK_IMPORTED_MODULE_1__GameManager__["a" /* default */].initialSetup();
});
...
class BombSpawnManager {
    constructor(gameContainer) {
        this.MAX_MINUTES = 2;
        this.INTERVAL_MAX_SECONDS = 5;
        this.INTERVAL_MIN_SECONDS = 0.5;
        this.BOMB_WIDTH_VH = 10;
        this.BOMB_HEIGHT_VH = 10;
        this.allBombs = [];
        this.bombsContainer = document.createElement('div');
        this.spawningEndTime = Date.now() + (this.MAX_MINUTES * 60 * 1000);
        __WEBPACK_IMPORTED_MODULE_3_jquery___default()(this.bombsContainer)
    ...
    spawnBomb() {
        let bomb = new __WEBPACK_IMPORTED_MODULE_0__Bomb__["a" /* default */]();
        ...
        if (Date.now() > this.spawningEndTime || this.allBombs.length > 120) {
            __WEBPACK_IMPORTED_MODULE_1__GameManager__["a" /* default */].gameOver();
        }
        else {
...
class Bomb {
    constructor() {
        this.svg = '<svg viewBox="0 0 97.324 97.324"><use xlink:href="images/bomb.svg#bomb" /></svg>';
        this.enabled = true;
        this.class = 'bomb-' + Date.now();
        this.color = __WEBPACK_IMPORTED_MODULE_1__Colors__["a" /* default */].getRandomColorHex(true);
        this.$html = __WEBPACK_IMPORTED_MODULE_2_jquery___default()('<div>')
    ...
    onDropped(collided) {
        let initialBounds = this.$html[0].getBoundingClientRect();
...
class BinSpawnManager {
    constructor(game) {
        this.bins = [new __WEBPACK_IMPORTED_MODULE_0__Bin__["a" /* default */], new __WEBPACK_IMPORTED_MODULE_0__Bin__["a" /* default */], new __WEBPACK_IMPORTED_MODULE_0__Bin__["a" /* default */]];
        this.$binsContainer = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div class="bins-container">')
            .append(this.bins.map((e) => e.html))
            .appendTo(game);
        this.$swapColorCountdown = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div class="bin-timer-countdown">')
            .appendTo(game);
        this.startCountdown();
    }
    startCountdown() {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = BinSpawnManager;
...
class Bin {
    constructor() {
        this.widthVw = 7;
        this.svg = '<svg viewBox="0 0 59 59"><use xlink:href="images/bin.svg#bin" /></svg>';
